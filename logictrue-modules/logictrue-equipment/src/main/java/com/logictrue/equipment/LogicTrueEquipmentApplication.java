package com.logictrue.equipment;
...
public class LogicTrueEquipmentApplication
{
    public static void main(String[] args)
    {
        SpringApplication.run(LogicTrueEquipmentApplication.class, args);
        System.out.println("设备模块启动成功 \n" +
                "                           _ooOoo_\n" +
                "                          o8888888o\n" +
                "                          88\" . \"88\n" +
                "                          (| -_- |)\n" +
