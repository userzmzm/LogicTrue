package com.logictrue.production;
...
public class LogicTrueProductionApplication
{
    public static void main(String[] args)
    {
        SpringApplication.run(LogicTrueProductionApplication.class, args);
        System.out.println("生产模块启动成功 \n" +
                "                           _ooOoo_\n" +
                "                          o8888888o\n" +
                "                          88\" . \"88\n" +
                "                          (| -_- |)\n" +
